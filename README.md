...
### Ejercicio01
---
**Edad para Votar:** Determinar si una persona es elegible para votar en función de su edad *(mayor o igual a 16 años)*.
...
### Problema03
---
**Mayor de tres números:** Dados tres números distintos, determinar cuál es el mayor. 
